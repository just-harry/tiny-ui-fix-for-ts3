...
$TinyUIFixPath = $Data.TinyUIFixCoreBridgePath
$TinyUIFixBuildSuffix = "$Configuration/$TargetFramework"
$TinyUIFixCoreBridgeAssemblyPrefix = $Data.TinyUIFixCoreBridgeAssemblyPrefix
...
{
	if ($_.Name.StartsWith($TinyUIFixCoreBridgeAssemblyPrefix))
	{
