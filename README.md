...
1. Download the patch's Batch file, `tiny-ui-fix-for-ts3.bat`, from [https://github.com/just-harry/tiny-ui-fix-for-ts3/releases/download/v1.4.2/tiny-ui-fix-for-ts3.bat](https://github.com/just-harry/tiny-ui-fix-for-ts3/releases/download/v1.4.2/tiny-ui-fix-for-ts3.bat).
...
1. Download the zip containing the patch's Shell script, `tiny-ui-fix-for-ts3.command.zip`, from [https://github.com/just-harry/tiny-ui-fix-for-ts3/releases/download/v1.4.2/tiny-ui-fix-for-ts3.command.zip](https://github.com/just-harry/tiny-ui-fix-for-ts3/releases/download/v1.4.2/tiny-ui-fix-for-ts3.command.zip).
...
The PowerShell script and its accompanying files can be downloaded as a zip-archive from [https://github.com/just-harry/tiny-ui-fix-for-ts3/releases/download/v1.4.2/tiny-ui-fix-for-ts3.zip](https://github.com/just-harry/tiny-ui-fix-for-ts3/releases/download/v1.4.2/tiny-ui-fix-for-ts3.zip). \
