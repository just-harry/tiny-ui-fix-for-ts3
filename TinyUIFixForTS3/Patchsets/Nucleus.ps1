...
[PSCustomObject] @{
	...
	DuringUIScaling = @{
		ReplaceResources = `
		{
			...
			$TinyUIFixForTS3DLL.Version = $State.S3SAMetadata.Version
			$TinyUIFixForTS3DLL.GameVersion = $State.S3SAMetadata.GameVersion
			$TinyUIFixForTS3DLL.Unknown2 = $State.S3SAMetadata.Unknown2
			...
			$TinyUIFixForTS3CoreBridge.Version = $State.S3SAMetadata.Version
			$TinyUIFixForTS3CoreBridge.GameVersion = $State.S3SAMetadata.GameVersion
			$TinyUIFixForTS3CoreBridge.Unknown2 = $State.S3SAMetadata.Unknown2
